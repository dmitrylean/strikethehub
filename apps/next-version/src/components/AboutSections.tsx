      ...
      <section className="bg-[#0d0d0d] py-16 px-5">
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-5">
            {["#4b2a73", "#6e4b2f", "#2c5f4a"].map((color, i) => (
              <div
                key={i}
                className="bg-[#1a1a1a] text-[#ccc] rounded-xl p-5 w-[300px]"
              >
                <span
                  className="inline-block text-white text-xs px-3 py-1 rounded-md mb-2"
